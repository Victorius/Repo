...
public class SWTMultipleAxisDemo1
{
    ...
    private static JFreeChart createChart() {
        ...
        XYDataset dataset1 = createDataset("Series 1", 100.0, new Year(),
                200);
        ...
        XYDataset dataset2 = createDataset("Series 2", 1000.0, new Year(),
                170);
        ...
        XYDataset dataset3 = createDataset("Series 3", 10000.0, new Year(),
                170);
        ...
        XYDataset dataset4 = createDataset("Series 4", 25.0, new Year(), 200);
     ...
     * @return A panel.
     */
    public static ChartFrame createDemoPanel() {
        JFreeChart chart = createChart();
        return new ChartFrame("sample",chart);
    }
