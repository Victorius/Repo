...
public class GBPJPY  extends CommonHandlerForPair{
    ...
    public ArrayList<Float> getClosePrice(String FromDate,String ToDate)throws SQLException{
        if(dbc!=null){
            ...
            ResultSet rs = dbc.getData("SELECT close_price FROM HISTORICAL_DATA.GBP_JPY WHERE DAY_DATE BETWEEN "+FromDate2+" AND "+FromDate+";");
    ...
    public ArrayList<ArrayList<Object>> getAllData(){
        ...
        ResultSet rs = this.dbc.getData("SELECT DAY_DATE,close_price from historical_data.gbp_jpy");
        try {
